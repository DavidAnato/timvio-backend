...
const { register, login, verifyOTP, resendOTP, forgotPassword, resetPassword, changePassword } = require('../controllers/authController');
 ...
 *   post:
 *     summary: Réinitialisation du mot de passe avec OTP
 *     tags: [Authentication]
 *     requestBody:
 *       required: true
 *       content:
